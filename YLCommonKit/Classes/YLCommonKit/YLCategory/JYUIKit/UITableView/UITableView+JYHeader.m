...
#import "UITableView+JYHeader.h"
#import <objc/runtime.h>
@implementation UITableView (JYHeader)
...
- (void)tapHeaderView:(UITapGestureRecognizer *)sender {
    ...
    if ([(id <UITableViewDelegate_HeaderViewSelection>)self.delegate respondsToSelector:@selector(tableView:didSelectHeaderView:inSection:isSelected:)]) {
        [(id <UITableViewDelegate_HeaderViewSelection>)self.delegate tableView:self didSelectHeaderView:headerView inSection:section isSelected:isSelected];
    }
}
